...
```
**Yet the Tables generated by paddleOCR are HTML tables, not the simple, classic "|" table, LLM's performance may degrade and not tested.**
**It is highly recommended to convert those into "|" style markdown tables using pandas(regex detect html tables->csv with "|" seperator)**
